    ...
    <div class="row m-0">
        <div class="col-10 offset-1 p-0">
            <div class="add-post-content">
                ...
                <form method="POST" action="<?=HOST?>myorder-delete?id=<?=$order->id?>">
                    <div class="add-post-content__submit mt-30">
                        <input class="button button-delete mr-20" type="submit" name="myorderDelete" value="Удалить">
                        <a class="button" href="<?=HOST?>myorders">Отмена</a>
                    </div>
                </form>
            </div>
        </div>
