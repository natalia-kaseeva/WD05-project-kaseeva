            ...
            <div class="add-post-content">
                ...
                <form method="POST" action="<?=HOST?>blog/category-new">
                    <div class="add-post-content__name mt-40">
                        ...
                        <input class="input" name="catTitle" id="inputCategory" type="text" placeholder="Введите название категории"/>
                    </div>
                    <div class="add-post-content__submit mt-30">
                        <input class="button button-save mr-20" type="submit" name="catNew" value="Добавить"/>
